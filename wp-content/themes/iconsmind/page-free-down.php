...
<div class="site__content">
    ...
    <div class="head-title head-title_2">
        ...
        <div class="head-title__inner">
            ...
            <h1 class="site__title site__title_4">Free icons pack</h1>
            <span class="head-title__subtitle">Subscribe to our newsletter and get your Free 100 iOS line Icons now. Just fill your name and email address</span>
    ...
    <div class="icons-set">
        ...
        <div class="site__center">
            ...
            <!-- icons-set__title -->
            <div class="icons-set__title">Preview</div>
            <!-- /icons-set__title -->
